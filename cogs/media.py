...
class Media(commands.Cog):
    ...
    async def _populate_embeds(self, media_ids: list, media_type: str):
        """populate embed list"""
        embeds = []
    ...
    async def _get_ids(self, query: str, media_type: str):
    ...
    async def _get_embed_by_tt(self, tt: str, media_type: str):
