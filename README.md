...
--- | --- | ---
!ai <query> || Interacts with Google Gemini about *query*
...
Command | Aliases | Description
--- | --- | ---
!avatar *@user* || Shows an enlarged version of *@user*'s avatar
...
!user *@user* || Sends info about *@user*

### **Comics**
Command | Aliases | Description
--- | --- | ---
!boondocks *[arg]* | bd | Sends today's Boondocks comic strip. Optional arguments: -r or -random to show a random comic, date (ex: 3/4/98) to show specified day's comic.
!cah  *[arg]* | c&h | Sends today's Calvin & Hobbes comic strip Optional arguments: -r or -random to show a random comic, date (ex: 3/4/98) to show specified day's comic.
!garfield  *[arg]* | gf | Sends today's Garfield comic strip Optional arguments: -r or -random to show a random comic, date (ex: 3/4/98) to show specified day's comic.
!gmg || Sends a random Garfield Minus Garfield comic strip
!peanuts  *[arg]* | p | Sends today's Peanuts comic strip Optional arguments: -r or -random to show a random comic, date (ex: 3/4/98) to show specified day's comic.
!peanutsb  *[arg]* | pb | Sends today's Peanuts Begins comic strip Optional arguments: -r or -random to show a random comic, date (ex: 3/4/98) to show specified day's comic.
...
!cow || Sends a random fact about cows
...
!he || Sends hee hee hee hee image
!hello | hi, hey | Sends Bronson's famous hello message
!hoot || Sends Jowl's hoot
...
!citation | cn || Sends citation needed image
...
!tts *message* || Sends text-to-speech mp3 of *message*
!vapor || Sends a chart of the vaporization points of various cannabinoids

### **Quotes**
Command | Aliases | Description
--- | --- | ---
!homer || Sends a random Homer Simpson quote
